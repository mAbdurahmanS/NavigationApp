...
public class MainActivity extends AppCompatActivity {
    ...
    private void showNotification(){
        ...
        String CHANNERL_NAME = "notif channel";
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(CHANNEL_ID, CHANNERL_NAME, NotificationManager.IMPORTANCE_DEFAULT);
